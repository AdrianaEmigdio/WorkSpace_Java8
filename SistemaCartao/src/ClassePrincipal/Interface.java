...
public class Interface {
	public static void main (String [] args ) {
		/* segredo do sucesso em herança/polimorfismo
		 * 
		 * Passo 1 - declarar genérico (da classe Pai)
		 */
		CartaoPrePago cartoes[]; 
		cartoes = new CartaoPrePago[4];
		
		
		/* Passo 2 - Instanciar específico - Pode ser tanto classe Pai quanto classes filhas 
		 * 
		 */
